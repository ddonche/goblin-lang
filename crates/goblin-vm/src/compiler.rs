...
pub fn builtin_by_name(name: &str) -> Option<BuiltinId> {
    Some(match name {
        ...
        "get_first!"                     => BuiltinId::GetFirst,
        "get_last!"                      => BuiltinId::GetLast,
        "get_at!"                        => BuiltinId::GetAt,
        "get_where!"                     => BuiltinId::GetWhere,
        "get_all!"                       => BuiltinId::GetAll,
        "get_matching!"                  => BuiltinId::GetMatching,
        "get_between!"                   => BuiltinId::GetBetween,
        "get_random!"                    => BuiltinId::GetRandom,
